...
import ToolAttachments from "./components/ToolAttachments";
...
import { MotorBusProvider } from "./components/MotorBusContext";
...
function SO101AssemblyContent() {
  ...
  const sections = useMemo(
    ...
    [t.assembly, t.calibrate, t.configure, t.source],
  );
...
function SO101AssemblyPageWrapper() {
  ...
  const handleSetLocale: Dispatch<SetStateAction<"en" | "zh">> =
    useCallback(
      (nextLocale) => {
  ...
  return (
    <LocaleProvider value={[locale, handleSetLocale]}>
      <MotorBusProvider>
