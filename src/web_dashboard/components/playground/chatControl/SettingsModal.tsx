...
export function SettingsModal({
  ...
  type ModelType = "Google" | "OpenAI" | "Ollama" | "Custom";
  ...
  useEffect(() => {
    if (show) {
      ...
      if (base === "https://api.openai.com/v1/") {
        ...
        setModelState(getModelFromLocalStorage() || "gpt-4.1-mini");
      } else if (base === "" || base == null) {
        setModelType("Google");
        setBaseURLState("");
        setModelState(getModelFromLocalStorage() || "gemini-2.5-flash");
      ...
      >
        ...
        <div className="flex items-center mb-4 ml-4">
          ...
          <input
            ...
            placeholder={
              modelType === "OpenAI" || modelType === "Google"
                ? "Not required"
                : modelType === "Ollama"
